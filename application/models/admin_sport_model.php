...
class Admin_sport_model extends CI_Model{
	...
	function list_data() {
		$query = "select * from sports order by sport_id";
	...
	function read_id($id)
	{
		...
		$this->db->where('a.sport_id', $id);
		$query = $this->db->get('sports a', 1); // parameter limit harus 1
