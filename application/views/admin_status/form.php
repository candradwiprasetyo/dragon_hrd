                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <label>Name</label>
                                    <input readonly required type="text" name="i_name" class="form-control" placeholder="" value="<?= $this->access->format_status(@$data['status_name']) ?>" title="Fill status name"/>
                                			</div>
                                      ...
                                      <div class="form-group">
                                           ...
                                           <textarea id="editor" name="editor" rows="10" cols="80">
                                            <?php
                                            echo @$data['status_email_content']
                                            ?>
                                        </textarea>
                                        </div>
