...
<html>
    ...
    <body >
        ...
        <div class="form-box" id="login-box">
            <div class="header"><div class="bg-logo"><span style="font-size: 1.3em !important;"><strong>Dragon HRD</strong></span><br>System</div></div>
                ...
                <div class="body bg-white">
                   ...
                   User login or Password incorrect
                    ...
                    <div class="form-group">
                        <input style="border:1px solid #eee;" required type="text" name="i_username" class="form-control" placeholder="Email"/>
                    </div>
                    <div class="form-group">
