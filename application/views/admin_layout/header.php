...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?= ucwords($data_head['title']) ?> | Dragon HRD</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
           ...
           <div style="font-weight:bold; text-align:center; padding-top: 10px;">Dragon HRD</div>
               <div style="font-size:12px; font-weight:bold; color:#ccc; text-align:center">System</div>
