										   ...
										   foreach($list as $row): ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    ...
                                                    <a href="<?= site_url() ?>admin_tool/form/<?= $row['tool_id']?>" class="btn btn-default" ><i class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['tool_id']; ?>, '<?= site_url().'admin_tool/delete/'; ?>')" class="btn btn-default" ><i class="fa fa-trash-o"></i></a>
